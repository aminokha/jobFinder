package com.example.jobfinder.Searcher;
...
public class SignInSearcher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_in_searcher);
        initViews();
        ...
        signIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(phone) || TextUtils.isEmpty(password)) {
                    ...
                    Toast.makeText(SignInSearcher.this, "Please fill the information", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void signIn(String phone, final String password) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(SignInSearcher.this);
        ...
        databaseReference.child(phone).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    if (password.equals(dataPass)) {
                        ...
                        Intent toHome = new Intent(SignInSearcher.this, SignupActivity.class);
                        startActivity(toHome);
                        finish();
                    } else {
                        progressDialog.dismiss();
                        Toast.makeText(SignInSearcher.this, "Your password is wrong ", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    progressDialog.dismiss();
                    Toast.makeText(SignInSearcher.this, "This phone number is not exists , please sign up", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(SignInSearcher.this, "Error : " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void initViews() {
        editTextPhoneNumber = findViewById(R.id.edtPhoneIN_Searcher);
        editTextPassword = findViewById(R.id.edtPasswordIN_Searcher);
        signIn = findViewById(R.id.btnSignIn_Searcher);
        toSignUp = findViewById(R.id.to_sign_up_Searcher);
